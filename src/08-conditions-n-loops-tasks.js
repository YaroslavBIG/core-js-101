 ...
 *   -1,1  =>  0  ( = -1 + 0 + 1 )
 */
function getSumBetweenNumbers(n1, n2, summa = 0) {
  if (n1 > n2) { return summa; }
  const sum = summa === 0 ? n1 : summa + n1;
  return getSumBetweenNumbers(n1 + 1, n2, sum);
}
...
function findFirstSingleChar(str) {
  ...
  const minEl = Object.entries(obj).sort((a, b) => a[1] - b[1])[0][0];
  return obj[minEl] === 1 ? minEl : null;
}
